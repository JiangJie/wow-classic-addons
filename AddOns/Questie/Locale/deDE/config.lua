QuestieLocale.locale['deDE'] = {
    ...
    ['LEVEL_HEADER'] = "Quest Level Einstellungen",
    ['ENABLE_LOWLEVEL'] = "Zeige niedrigstufige Quests",
    ['ENABLE_LOWLEVEL_DESC'] = "Aktiviert/Deaktiviert, ob niedrigstufige Quests auf der Karte gezeigt werden.",
    ...
    ['CLUSTER_DESC'] = "Wieviele Ziel Icons in einem Cluster gezeigt werden sollen.",
    ...
    ['MINIMAP_FADE'] = "Verschwinden der Minimap Notizen",
    ['MINIMAP_FADING'] = "Anzahl verblassender Ziele",
    ['MINIMAP_FADING_DESC'] = "Wieviele Ziele verblassen abhängig von der Distanz. ( Standard: %s )",
    ...
    ['MINIMAP_FADE_PLAYER_LEVEL_DESC'] = "Wieviel die Icons verblassen um den Spieler herum verblassen sollen. ( Standard: %s )",
    ...
    ['ENABLE_MAP_BUTTON_DESC'] = "Aktiviert/Deaktiviert den Zeigen/Verstecken Button an der Weltkarte (repariert möglicherweise Interaktionen mit Karten Addon).",
    ['MAP_NOTES'] = "Weltkarten Notiz Einstellungen",
    ['MAP_GLOBAL_SCALE'] = "Gloable Skalierung der Weltkarten Icons",
    ['MAP_GLOBAL_SCALE_DESC'] = "Skaliert wie groß die Weltkarten Icons sind. ( Standard: %s )",
    ...
    ['MAP_COORDS_PRECISION_DESC'] = "Wieviele Nachkommastellen in die Genauigkeit für Spieler und Mauszeiger Koordinanten einfließen sollen. ( Standard: %s )",
    ...
    ['AVAILABLE_ICON_SCALE'] = "Skalierung der Icons für verfügbare/abgeschlossene Quest",
    ['AVAILABIE_ICON_SCALE_DESC'] = "Skaliert wie groß die Icons der verfügbaren/abgeschlossenen Quests sind. ( Standard: %s )",
    ...
    ['NAMEPLATE_RESET_BTN'] = "Nameplaketten zurücksetzen",
    ...
    ['ICON_CTRLRIGHT_CLICK'] = "Ctrl + Rechtsklick",
    ...
    ['JOURNEY_SELECT_ZONE'] = "Wähle deine Yone",
    ...
    ['JOURNEY_QUEST_LEVEL'] = "Empfohlendes Quest Level: ",
    ...
    ['JOURNEY_ERR_NONOTE'] = "Keine Notzi angegeben. DU musst eine Notiz angeben bevor ein Eintrag angelegt werden kann.",
    ...
    ['JOURNEY_NOTE_CREATED'] = "Noitz erstellt: %s",
    ...
    ['DEBUG_POP_ERROR'] = "Es gab einen Fehler beim  There was an error weitergeben der Ziele für %s %s %s %s",
    ['DEBUG_UNHANDLE_FINISH'] = "Unbehandelter Endungstyp: %s %s %s",
    ['DEBUG_NO_FINISH'] = "Quest hat keinen Endpunkt: %s %s",
    ['DEBUG_POPULATE_ERR'] = "Es gab einen Fehler beim  There was an error weitergeben der Ziele für %s %s %s %s",
